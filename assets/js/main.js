...
const sr = ScrollReveal({
    ...
    duration: 2500,
    delay: 300,
    reset: true, // Animation restart
})
sr.reveal(`.home__data, .favorites__container, .products__container, .footer__container`)
sr.reveal(`.home__circle, .home__img, .products__img`, {delay: 600, scale: .5})
